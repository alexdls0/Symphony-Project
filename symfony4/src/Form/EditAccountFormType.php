...
class EditAccountFormType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder->add('nombre', TextType::class, [
            ...
            'attr' => ['class' => 'text required form-control']
        ]);
        ...
        $builder->add('correo', EmailType::class, [
            ...
            'attr' => ['class' => 'text email required form-control'],
        ]);
        ...
        $builder->add('locale', ChoiceType::class, [
            ...
            ->add('videolang', ChoiceType::class, [
                'required' => false,
                'label' => 'Video playback language',
                'choices' => $isonew
            ])
            ->add('sendPassword', CheckboxType::class, [
                    'mapped' => false,
                    'label' => 'Send password change email',
                    'required' => false,
                    'attr' => ['class' => 'row-inline'],
            ])
