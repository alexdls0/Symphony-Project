 ...
 * @UniqueEntity(fields={"titulo"}, message="This director already exists")
 */
class Director extends Contenido
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Video", mappedBy="director")
     */
    private $videos;
